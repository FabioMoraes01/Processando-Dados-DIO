...
insert into employee values ('John', 'B', 'Smith', 123456789, '1965-01-09', '731-Fondren-Houston-TX', 'M', 30000, NULL, 5),
                            ...
                            ('Alicia', 'J', 'Zelaya', 999887777, '1968-01-19', '3321-Castle-Spring-TX', 'F', 25000, 888665555, 4),
                            ('Jennifer', 'S', 'Wallace', 987654321, '1941-06-20', '291-Berry-Bellaire-TX', 'F', 43000, 888665555, 4),
                            ('Ramesh', 'K', 'Narayan', 666884444, '1962-09-15', '975-Fire-Oak-Humble-TX', 'M', 38000, 123456789, 5),
                            ('Joyce', 'A', 'English', 453453453, '1972-07-31', '5631-Rice-Houston-TX', 'F', 25000, 123456789, 5),
...
SELECT e.Fname, e.Minit, e.Lname, e.Ssn, e.Super_ssn, d.Dname AS Department_Name
FROM employee e
JOIN departament d ON e.Dno = d.Dnumber;

SELECT e.Fname AS Employee_Name, e.Ssn AS Employee_Ssn, 
       m.Fname AS Manager_Name, m.Ssn AS Manager_Ssn
FROM employee e
...
SELECT CONCAT(d.Dname, ' ', dl.Dlocation) AS Department_Location
FROM departament d
JOIN dept_locations dl ON d.Dnumber = dl.Dnumber;

SELECT e.Super_ssn AS Manager_Ssn, 
